...
(
    ...
    CONSTRAINT organizations_categories_map_pkey PRIMARY KEY (id),
    CONSTRAINT organizations_categories_map_categories_fkey FOREIGN KEY (category_id)
        REFERENCES charity.categories (id) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION,
    ...
    CONSTRAINT organizations_categories_map_subcategories_fkey FOREIGN KEY (subcategory_id)
        REFERENCES charity.subcategories (id) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION
)
